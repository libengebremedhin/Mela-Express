...
class Service(models.Model):
    ...
    origin = models.ForeignKey(City, on_delete=models.SET_NULL, null=True, related_name='origin')
    destination = models.ForeignKey(City, on_delete=models.SET_NULL, null=True, related_name='destination')
